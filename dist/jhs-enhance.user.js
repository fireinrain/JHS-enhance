...
(function ($$1, localforage$1, Toastify$1, md5$1, tabulatorTables, Viewer$1, QRCode$1) {
  'use strict';

  var __defProp = Object.defineProperty, __typeError = (msg) => {
    throw TypeError(msg);
  }, __publicField = (obj, key, value) => ((obj2, key2, value2) => key2 in obj2 ? __defProp(obj2, key2, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: value2
...
`;
  ...
  window.md5 = md5$1;
  window.Tabulator = tabulatorTables.TabulatorFull;
...
`,
  ...
  __publicField(_HotkeyManager, "registerHotKeyMap", /* @__PURE__ */ new Map());
    ...
    openFc2Dialog(movieId, carNum2, href) {
      ...
      layer.open({
        ...
        success: (layero, index) => {
          ...
          $("#search-subtitle-btn").on("click", ((event) => utils.openPage(`https://subtitlecat.com/index.php?search=${carNum2}`, carNum2, false, event)));
...
${err.stack}` : "");
  ...
  const _WangPan115MatchPlugin = class _WangPan115MatchPlugin2 extends BasePlugin {
    constructor() {
      super(...arguments);
      __publicField(this, "loginStatus", _WangPan115MatchPlugin2.LoginStatus.UNCHECKED);
    }
    getName() {
...
})($, localforage, Toastify, md5, Tabulator, Viewer, QRCode);